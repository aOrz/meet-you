      ...
      <div class="row" style="margin-bottom: 10%; font-size: 17px;">
        ...
        <div class="col-xs-7" style="text-align: center">
          <table border="0">
            ...
            <tr>
              <td width="120px" height="80px"><b>借阅ID</b></td>
              <td><input type="text" class="form-control input-lg" style = "width:200px" id="borrowID" disabled></td>
            </tr>
            <td width="120px" height="80px"></td>
              <td><input type="button" class="btn btn-warning btn-lg" value="归还" id="return"></td>
            </tr>
            <input type="hidden" class="form-control input-lg" style = "width:300px" id="code">
          </table>
        </div>
      </div>
    ...
    $("#search").click(function(){
      ...
      if (!bookCode) {
        ...
        $.ajax({
          type: 'GET',
          cache: false,
          url: '../../controller/searchReturnController.php',
          data: {
            bookcode: bookCode
          },
    ...
    $("#return").click(function(){
      if(!$("#code").val()){
        ...
        $.ajax({
          type: 'GET',
          cache: false,
          url: '../../controller/returnController.php',
          data: {
            bookcode: $("#code").val()
          },
          success: function(data){
